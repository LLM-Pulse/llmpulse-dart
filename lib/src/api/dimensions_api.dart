...
class DimensionsApi {
  ...
  const DimensionsApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CompetitorDetails] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CompetitorDetails>> getCompetitorDetails({ 
    ...
    final _path = r'/dimensions/competitors/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    ...
    CompetitorDetails? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CompetitorDetails),
    ...
    return Response<CompetitorDetails>(
      data: _responseData,
  ...
  Future<Response<void>> listCollections({ 
    ...
    final _path = r'/dimensions/collections';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [projectId] - Project ID
  /// * [includeProjectBrand] - When true, prepends the project brand with actor_type=project and is_own=true
  /// * [output] - Rectangular output for BI tools (Tableau, Excel, Sheets, ELT). Omit for the default nested JSON. 'flat' returns the same metadata plus 'columns' and 'rows'; 'csv' returns those rows as text/csv. Errors are always returned as JSON.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListCompetitors200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListCompetitors200Response>> listCompetitors({ 
    required int projectId,
    bool? includeProjectBrand = false,
    String? output,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/dimensions/competitors';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'project_id': encodeQueryParameter(_serializers, projectId, const FullType(int)),
      if (includeProjectBrand != null) r'include_project_brand': encodeQueryParameter(_serializers, includeProjectBrand, const FullType(bool)),
      if (output != null) r'output': encodeQueryParameter(_serializers, output, const FullType(String)),
    };
    ...
    ListCompetitors200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ListCompetitors200Response),
      ) as ListCompetitors200Response;
    ...
    return Response<ListCompetitors200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
