...
class AnswersApi {
  ...
  const AnswersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [AnswerDetails] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AnswerDetails>> getAnswer({ 
    required int projectId,
    required int id,
    bool? includeSourcePageDetails = false,
    ...
    final _path = r'/answers/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (includeSourcePageDetails != null) r'include_source_page_details': encodeQueryParameter(_serializers, includeSourcePageDetails, const FullType(bool)),
    };
    ...
    AnswerDetails? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AnswerDetails),
      ) as AnswerDetails;
