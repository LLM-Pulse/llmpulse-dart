...
class ProjectsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ProjectCreateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProjectCreateResponse>> createProject({ 
    ...
    ProjectCreateResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProjectCreateResponse),
    ...
    return Response<ProjectCreateResponse>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> createProjectDraft({ 
    required CreateProjectDraftRequest createProjectDraftRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(CreateProjectDraftRequest);
      _bodyData = _serializers.serialize(createProjectDraftRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> finalizeProjectDraft({ 
    required String id,
    FinalizeProjectDraftRequest? finalizeProjectDraftRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/project_drafts/{id}/finalize'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(FinalizeProjectDraftRequest);
      _bodyData = finalizeProjectDraftRequest == null ? null : _serializers.serialize(finalizeProjectDraftRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProjectDetails] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProjectDetails>> getProjectDetails({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/dimensions/projects/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ProjectDetails? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProjectDetails),
      ) as ProjectDetails;
  ...
  /// Parameters:
  /// * [id] - Draft id (draft_...)
  /// * [includeSuggestions] - Cache-only: returns suggestions for the current step if already generated, never triggers AI
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getProjectDraft({ 
    required String id,
    ...
    final _path = r'/project_drafts/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (includeSuggestions != null) r'include_suggestions': encodeQueryParameter(_serializers, includeSuggestions, const FullType(bool)),
    };
  ...
  Future<Response<void>> listLocales({ 
    ...
    final _path = r'/dimensions/locales';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> listModels({ 
    ...
    final _path = r'/dimensions/models';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ListProjects200Response>> listProjects({ 
    ...
    final _path = r'/dimensions/projects';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateProject({ 
    required int id,
    ...
    final _path = r'/projects/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateProjectDraft({ 
    required String id,
    required UpdateProjectDraftRequest updateProjectDraftRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateProjectDraftRequest);
      _bodyData = _serializers.serialize(updateProjectDraftRequest, specifiedType: _type);
