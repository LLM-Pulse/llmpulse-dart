...
class HealthApi {
  ...
  ///
  /// Parameters:
  /// * [projectId] - Optional project to verify access for
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [Ping200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Ping200Response>> ping({ 
    int? projectId,
    ...
    Ping200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Ping200Response),
      ) as Ping200Response;
    ...
    return Response<Ping200Response>(
      data: _responseData,
