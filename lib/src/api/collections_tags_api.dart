...
class CollectionsTagsApi {
  ...
  const CollectionsTagsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> assignPromptTags({ 
    ...
    final _path = r'/prompts/assign_tags';
    ...
    try {
      const _type = FullType(AssignPromptTagsRequest);
      _bodyData = _serializers.serialize(assignPromptTagsRequest, specifiedType: _type);
