...
class AnnotationsApi {
  ...
  Future<Response<void>> createAnnotation({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createAnnotationRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteAnnotation({ 
    ...
    final _path = r'/annotations/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> listAnnotations({ 
    required int projectId,
    Date? from,
    Date? to,
    int? annotationCategoryId,
    int? page = 1,
    int? perPage = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (annotationCategoryId != null) r'annotation_category_id': encodeQueryParameter(_serializers, annotationCategoryId, const FullType(int)),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateAnnotation({ 
    required int id,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateAnnotationRequest, specifiedType: _type);
