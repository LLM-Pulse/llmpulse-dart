...
class MentionsCitationsApi {
  ...
  const MentionsCitationsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> listAllCitations({ 
    ...
    final _path = r'/dimensions/all_citations';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> listAllMentions({ 
    required int projectId,
    String? competitors,
    int? page = 1,
    int? perPage = 20,
    ...
    final _path = r'/dimensions/all_mentions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> listCitations({ 
    ...
    final _path = r'/dimensions/citations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> listCompetitorCitations({ 
    required int projectId,
    String? competitors,
    int? page = 1,
    int? perPage = 20,
    ...
    final _path = r'/dimensions/competitor_citations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> listCompetitorMentions({ 
    ...
    final _path = r'/dimensions/competitor_mentions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> listMentions({ 
    ...
    final _path = r'/dimensions/mentions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
