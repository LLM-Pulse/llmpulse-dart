...
class ReputationStudiesApi {
  ...
  const ReputationStudiesApi(this._dio, this._serializers);
  ...
  ///
  /// Parameters:
  /// * [id] - The report id from GET /reputation/reports
  /// * [projectId] - Project ID
  /// * [page] 
  /// * [perPage] 
  /// * [model] - Restrict to one analyst model
  /// * [brand] - Restrict to one brand name, or a comma-separated list
  /// * [dimension] - Restrict to one reputation dimension key
  ...
  Future<Response<void>> getReputationReport({ 
    required String id,
    ...
    final _path = r'/reputation/reports/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  Future<Response<void>> getStudy({ 
    ...
    final _path = r'/studies/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [id] 
  /// * [reportId] - The report id from GET /studies/{id}
  /// * [page] 
  /// * [perPage] 
  /// * [model] - Restrict to one analyst model
  /// * [subject] - Restrict to one subject name, or a comma-separated list
  /// * [dimension] - Restrict to one dimension key
  /// * [output] - Rectangular output for BI tools (Tableau, Excel, Sheets, ELT). Omit for the default nested JSON. 'flat' returns the same metadata plus 'columns' and 'rows'; 'csv' returns those rows as text/csv. Errors are always returned as JSON.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getStudyReport({ 
    required int id,
    ...
    final _path = r'/studies/{id}/reports/{report_id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString()).replaceAll('{' r'report_id' '}', encodeQueryParameter(_serializers, reportId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> listReputationReports({ 
    required int projectId,
    int? page = 1,
    int? perPage = 20,
    String? output,
    ...
    final _path = r'/reputation/reports';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [projectId] - Restrict to studies attached to this project (plus account-level ones)
  /// * [status] 
  /// * [page] 
  /// * [perPage] 
  /// * [output] - Rectangular output for BI tools (Tableau, Excel, Sheets, ELT). Omit for the default nested JSON. 'flat' returns the same metadata plus 'columns' and 'rows'; 'csv' returns those rows as text/csv. Errors are always returned as JSON.
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> listStudies({ 
    int? projectId,
    String? status,
    int? page = 1,
    int? perPage = 20,
